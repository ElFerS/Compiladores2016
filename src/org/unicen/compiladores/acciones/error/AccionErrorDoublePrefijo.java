...
public class AccionErrorDoublePrefijo implements Accion {
	...
	public void ejecutar(String c, Token t, Archivo a, JTable jTableTokens, List listErrores, JTable jTableTS,
		...
		if (c!=null)
			a.retrocederIndice();
		listErrores.add("Error en línea "+a.obtenerLineaActual()+": se esperaba signo, punto o digito despues del prefijo.");
	}
